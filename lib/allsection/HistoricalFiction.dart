...
class HistoricalFication extends StatefulWidget {
  const HistoricalFication({ Key? key }) : super(key: key);

  @override
  _HistoricalFicationState createState() => _HistoricalFicationState();
}

class _HistoricalFicationState extends State<HistoricalFication> {
  late String urlv;
  late String titlev;
